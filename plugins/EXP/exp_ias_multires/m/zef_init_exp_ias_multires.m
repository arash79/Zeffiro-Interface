%ZEF_INIT_EXP_IAS_MULTIRES  Default exp_ias_* plus exp_multires_* on IAS-multires widgets.
%
%   Zeffiro Interface.
...
%   (exp_ias_iteration_multires / exp_make_multires_dec).
%
%   See also zef_update_exp_ias_multires, exp_make_multires_dec.
