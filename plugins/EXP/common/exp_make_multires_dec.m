...
%   top-level zef.exp_multires_* counts. Also called from
%   exp_ias_iteration_multires. No inputs.
%
%   See also exp_ias_iteration_multires, exp_iteration.
...
for n_rep = 1 : n_decompositions
    ...
    exp_multires_sparsity = evalin('base','zef.exp_multires_sparsity');
    ...
    for k = 1 : n_levels-1
        ...
        size_source_points = floor(size_center_points/exp_multires_sparsity^(n_levels - k));
