...
MATLAB logic: `plugins/FindSyntheticSource/m/` (`find_synthetic_source`, `add_synthetic_source`, `remove_synthetic_source`, `zef_update_fss`, `zef_find_source`, `zef_generate_time_sequence`, plot helpers).
