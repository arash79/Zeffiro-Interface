...
%
%   Layout only. Start runs zef_update_sl1 then zef_sl1_iteration.
%   zef_init_sl1 also sets the window title and the same Start callback.
%
...
h1 = figure(...
    ...
    'MenuBar','none',...
    'ToolBar','none',...
    'Name','Standardized L1 MAP inversion',...
    'NumberTitle','off',...
...
h3 = uicontrol(...
    ...
    'Callback','zef.sl1_hyperprior = get(gcbo,''Value'');',...
    'Children',[],...
    'CreateFcn', '',...
    'Tag','popupmenu2',...
    'UserData',[],...
...
h3b = uicontrol(...
    ...
    'Units','normalized',...
    'FontUnits','normalized',...
    'String',{  'None'; 'sLORETA'; 'Column maximum'},...
    'Style','popupmenu',...
    'Value',1,...
    'Position',[0.572410094823888 0.90 0.408063235649443 0.0497664429530199],...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_type = get(gcbo,''Value'');',...
    'Children',[],...
    'CreateFcn', '',...
    'Tag','popupmenu2',...
    'UserData',[],...
...
h5 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_n_map_iterations = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit3',...
    'FontSize',0.397787948131197);

zef.h_sl1_n_map_iterations = h5;
...
h7 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_sampling_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit6',...
    'FontSize',0.397787948131197);

zef.h_sl1_sampling_frequency = h7;
...
h9 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_low_cut_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit7',...
    'FontSize',0.397787948131198);

zef.h_sl1_low_cut_frequency = h9;
...
h11 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_high_cut_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '',...
    'Tag','edit8',...
    'FontSize',0.397787948131197);

zef.h_sl1_high_cut_frequency = h11;
...
h12 = uicontrol(...
    ...
    'Callback','zef_update_sl1; [zef.reconstruction, zef.reconstruction_information] = zef_sl1_iteration(zef);',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','pushbutton12',...
...
h13 = uicontrol(...
    ...
    'Callback','close(zef.h_sl1_map_estimation);',...
    'Children',[],...
    'CreateFcn','',...
    'Tag','pushbutton13',...
    'FontSize',0.280661496737012);

zef.h_sl1_cancel = h13;
...
h15 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_number_of_frames = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit10',...
    'FontSize',0.397787948131197);

zef.h_sl1_number_of_frames = h15;
...
h17 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_snr = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit11',...
...
h20 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_normalize_data = get(gcbo,''value'');',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','popupmenu8',...
    'UserData',[],...
...
h22 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_time_1 = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit14',...
    'FontSize',0.397787948131197);

zef.h_sl1_time_1 = h22;
...
h24 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_time_2 = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit15',...
    'FontSize',0.397787948131197);

zef.h_sl1_time_2= h24;
...
h26 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.sl1_time_3 = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit19',...
    'FontSize',0.397787948131197);

zef.h_sl1_time_3= h26;
