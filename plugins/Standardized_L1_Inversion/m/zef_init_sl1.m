...
%ZEF_INIT_SL1  Open sL1 MAP window, default sl1_* fields, wire Start.
%
%   Zeffiro Interface.
...
%
%   zef = zef_init_sl1(zef)
%
%   Called via zef_tool_start from zef_sl1_map_estimation. Names
%   'ZEFFIRO Interface: Standardized Hierarchical L1 MAP estimation'.
%   Start → zef_update_sl1; zef_sl1_iteration(zef). Does not invert
%   by itself. Needs quadprog at Start.
%
%   See also zef_update_sl1, zef_sl1_iteration.
