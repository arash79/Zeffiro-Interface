...
| CRUD / payload | `zef_dataBank_add`, `_addButtonPress`, `_add_data_item`, `_getData`, `_setData`, `_delete` |
| Hash / uitree | `zef_dataBank_number2hash`, `_hash2tree`, `_sortTree`, `_rebuildTree`, `_rebuildTreeSaveFile`, `_refreshTree`, `_getHashForMenu`, `_getHashForTableMenu`, `_treeSearch` |
| Working / combine | `_hashToWorkingSpace`, `_WorkingSpaceInfo`, `_combineLeadFields` |
