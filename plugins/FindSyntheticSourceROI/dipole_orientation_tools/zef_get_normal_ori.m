...
%ZEF_GET_NORMAL_ORI  Cortical-normal orientations from procFile.s_ind_4.
%
%   Sources in procFile.s_ind_4 keep the normal stored in procFile (lead-field
%   processing). Other interpolated sources in the ROI get the user vector
%   s_o and a printed warning. Optional third argument is the ROI index
%   list; default is all of procFile.s_ind_0. Errors if the ROI does not
%   meet the interpolated set.
%
%   See also zef_find_source_ROI, zef_processLeadfields.
