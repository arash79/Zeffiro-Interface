%ZEF_INIT_FSS_ROI  Default 20-column synth_source_ROI onto the ROI widgets.
%
%   Zeffiro Interface.
...
%
%   Script. Called from zef_find_synthetic_source_ROI_window. Columns:
%   shape, radius, width, curvature, ori settings, ori xyz, center xyz,
%   dipole-ori style/xyz, amplitude, noise, plot style, color, length.
%   Does not write measurements.
%
%   See also zef_update_fss_ROI.
