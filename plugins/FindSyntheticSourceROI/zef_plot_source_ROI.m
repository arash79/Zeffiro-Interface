...
%ZEF_PLOT_SOURCE_ROI  Draw ROI geometry or dipoles on Figure-tool axes.
%
%   zef = zef_plot_source_ROI(zef)
%
%   Calls zef_find_source_ROI for positions/orientations/specs, deletes any
%   previous zef.h_synth_source overlay, then either
%   zef_plot_dipoles_in_ROI (plot style 2) or disk/sphere/ellipsoid
%   surfaces. Stores the new graphics handle on zef.h_synth_source.
%   Needs zef.h_axes1.
%
%   See also zef_find_source_ROI, zef_plot_dipoles_in_ROI, zef_plot_disk.
