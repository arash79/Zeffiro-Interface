function zef_dpq_plot_GMM
%ZEF_DPQ_PLOT_GMM  Queue renderer: GMMClustering ellipsoids/dipoles (zef.GMM).
%
%   Zeffiro Interface.
...
%
%   Queue List stores this filename, so zef_plot_dpq evalin-calls the bank
%   file. Reads zef.GMM.parameters.Values, meta{2}, model, dipoles. Caller
%   f_ind is the time-series frame. Axes: caller h_axes_image.
%
%   zef_dpq_plot_GMM
%
%   Non-cell model: one snapshot. Cell model: GMModel{f_ind}. Component
%   order: '1' stored, '2' by dipole amplitude, '3' explicit indices.
%   Custom-color numeric branch maps RGB values onto components.
