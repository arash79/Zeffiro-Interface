...
Align the start-file function name with the filename before relying on `nargin`/`nargout` patterns. Do not add an `inverse.*Inverter` here unless registering a new ROI method in the class registry.
