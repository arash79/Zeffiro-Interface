...
- Start: `zef_find_synthetic_source_legacy` → `zef_find_synthetic_source_legacy_window` → `zef_init_fss_legacy` (default `inv_synth_source` row `[0 0 0 1 0 0 10 0 3 1]` onto the ten widgets)
- Update: `zef_update_fss_legacy`
- Solver: `zef_find_source_legacy`
