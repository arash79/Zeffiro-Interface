function [meas_data] = zef_find_source_legacy(zef)
%ZEF_FIND_SOURCE_LEGACY  Legacy dipoles through L (linear noise fraction).
%
%   Zeffiro Interface.
...
%
%   meas_data = zef_find_source_legacy(zef)
%
%   Nearest source point; moment 1e-3*amp*ori. Noise is a linear fraction
%   inv_synth_source(1,8) of max(abs(meas)), not dB. One column. nargin
%   required (no base fallback).
%
