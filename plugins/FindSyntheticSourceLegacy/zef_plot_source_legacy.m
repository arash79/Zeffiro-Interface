function h_source = zef_plot_source_legacy(zef, source_type)
%ZEF_PLOT_SOURCE_LEGACY  3-D arrows for legacy synthetic (type 1) or reconstructed dipoles.
%
%   Zeffiro Interface.
...
%
%   h_source = zef_plot_source_legacy(zef, source_type)
%
%   Type 1: inv_synth_source (visual size/color from row 1, columns 9–10);
%   type 2: inv_rec_source. Draws on h_axes1 via zef_plot_3D_arrow. Does
%   not write measurements. Distinct from zef_plot_source (no zef argument).
%
