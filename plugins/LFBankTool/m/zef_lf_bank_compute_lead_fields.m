%ZEF_LF_BANK_COMPUTE_LEAD_FIELDS  Recompute L for selected bank items.
%
%   Zeffiro Interface.
...
%
%   Script. Re-calculate button. For each selected item: restore
%   sensors/imaging_method, zef_process_meshes, zef_attach_sensors_volume,
%   zef_lead_field_matrix; write L and interpolation back into the cell.
%   Temporarily turns source interpolation off after the first item.
%   Restores source_interpolation_on. Side effect: live zef.L/sensors.
%
%   See also zef_combine_lead_fields.
