...
MATLAB logic: `plugins/LFBankTool/m/` (`zef_lf_bank_tool`, `zef_add_lf_item`, `zef_combine_lead_fields`, `zef_delete_lf_item`, `zef_lf_bank_compute_lead_fields`, normalization helpers under `m/lead_field_normalization_functions/`).
