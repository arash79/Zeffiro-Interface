...
%   ('Please recalculate Gaussian mixture model.'). Cell amplitudes loop
...
if ~evalin('base','isfield(zef.GMM,''amplitudes'')')
    error('Amplitudes are not saved to zef.GMM structure. Please recalculate Gaussian mixture model.');
end
