...
%   via zef_tool_start(..., 'zef_open_mcmc', 1/4, 0). Start runs
%   zef_mcmc(zef) into reconstruction and reconstruction_information.
%   Needs zef.L and zef.measurements. No inverse.*Inverter.
%   nargin 0 / nargout 0 use base zef.
%
