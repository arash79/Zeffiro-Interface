...
%
%   Script. Increments bankSize, writes auxData into the new slot, then
%   zef_LeadfieldProcessingTool_updateTable. Used by Add, Mag2Grad, and
%   Combine after they fill auxData.
%
