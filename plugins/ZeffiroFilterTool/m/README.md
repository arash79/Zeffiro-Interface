...
| `zef_filter_substitute_*.m` | Copy processed/raw/measurement/noise between fields (`zef_filter_substitute_raw_data`, `_measurement_data`, `_noise_data`, `_raw_data_with_measurement_data`) |
...
- Save/load and epoch-point load use the file chosen in the dialog.
