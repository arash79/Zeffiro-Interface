...
%ZEF_ELLIP_HIGH_PASS_FILTER  Pipeline stage: elliptic high-pass (Signal Processing Toolbox ellip).
%
%   Zeffiro Interface.
...
%
%   Listed in the Filter tool from help() Description:. Add parses Input:
%   defaults. Called as str2func from zef_filter_raw_data. Skips if
%   edge_frequency is 0 or data is a single sample.
%
