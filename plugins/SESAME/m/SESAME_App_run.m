...
for zef_i = 1:length(zef_fields)
    if isprop(zef.SESAME_App,strcat('h_',zef_fields{zef_i}))
        if strcmp(zef.SESAME_App.(strcat('h_',zef_fields{zef_i})).Type,'uidropdown')
            ...
            try
                zef.SESAME_App.(strcat('h_',zef_fields{zef_i})).Value = zef_ui_num2str(zef.(zef_fields{zef_i}));
            catch
            end
        end
    end
...
zef.SESAME_App.h_inv_sampling_frequency.ValueChangedFcn = 'zef.inv_sampling_frequency = str2double(zef.SESAME_App.h_inv_sampling_frequency.Value);';
zef.SESAME_App.h_inv_low_cut_frequency.ValueChangedFcn = 'zef.inv_low_cut_frequency = str2double(zef.SESAME_App.h_inv_low_cut_frequency.Value);';
zef.SESAME_App.h_inv_high_cut_frequency.ValueChangedFcn = 'zef.inv_high_cut_frequency = str2double(zef.SESAME_App.h_inv_high_cut_frequency.Value);';
zef.SESAME_App.h_inv_time_1.ValueChangedFcn = 'zef.inv_time_1 = str2double(zef.SESAME_App.h_inv_time_1.Value);';
zef.SESAME_App.h_inv_time_2.ValueChangedFcn = 'zef.inv_time_2 = str2double(zef.SESAME_App.h_inv_time_2.Value);';
zef.SESAME_App.h_number_of_frames.ValueChangedFcn = 'zef.number_of_frames = str2double(zef.SESAME_App.h_number_of_frames.Value);';
zef.SESAME_App.h_inv_time_3.ValueChangedFcn = 'zef.inv_time_3 = str2double(zef.SESAME_App.h_inv_time_3.Value);';
zef.SESAME_App.h_inv_data_segment.ValueChangedFcn = 'zef.inv_data_segment = str2double(zef.SESAME_App.h_inv_data_segment.Value);';
zef.SESAME_App.h_normalize_data.ValueChangedFcn = 'zef.normalize_data = str2double(zef.SESAME_App.h_normalize_data.Value);';
...
zef_ui_adopt_app(zef.SESAME_App.UIFigure, 'ZEFFIRO Interface: SESAME');
