...
%
%   Used by plot_roi (arrow) and plot_graph type 12 (velocity histogram).
%   Averages bv_vessels_* over frames and ROI nodes from zef_nse_roi_ind.
%   Wave plots use zef_nse_vel_dir instead.
%
