...
%ZEF_INIT_SIGNAL_GENERAL_DATA  Default global signal parameters for the source tree.
%
%   gd = zef_init_signal_general_data()
%
%   Returns a struct of Name/Value leaves used by zef_simulate_jr_tree and
%   the SignalParameters table: samplingRate_Hz (1000), gaussianNoiseStd,
%   numFeedbackLoops, blockDuration_s, plotLoopIndex, gainConversion
%   (0.01), external box/Blackman–Harris pulse, and optional sinusoidal
%   modulation. Stored on zef.source_tree_signal_parameters.
%
%   See also zef_update_signal_parameters_table, zef_simulate_jr_tree.
