function zef = zef_ias_map_estimation_window(zef)
%ZEF_IAS_MAP_ESTIMATION_WINDOW  GUIDE figure dump: IAS MAP widgets.
%
%   Zeffiro Interface.
...
%
%   Layout only. Start runs zef_update_ias then zef_ias_iteration.
%   zef_init_ias also sets the window title and the same Start callback.
%
...
h12 = uicontrol(...
    ...
    'Callback','zef_update_ias; [zef.reconstruction, zef.reconstruction_information] = zef_ias_iteration(zef);',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','pushbutton12',...
