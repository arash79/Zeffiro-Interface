...
%
%   Plot-data menu item 3 and plot_type 3. Three uitabs (current pattern,
%   volume current, algorithm) with imagesc of table columns; yellow
%   marker at (sc,sr) from zef_ES_objective_function.
%
