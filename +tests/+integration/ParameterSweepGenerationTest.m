...
%
%   Skips if parcluster is missing, then unless ComputingProject (CSC)
%   is present. Builds a small sweep struct on synthetic zef and asserts
%   the submission shape is 4 jobs. See +tests/README.md.
%
