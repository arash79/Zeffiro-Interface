...
mfolder = fullfile ( this_folder, "src", "core" ) ;
...
if zeffiro_start_config_fid == -1
    error ( ...
        ...
        + "On Linux/Ubuntu this often means the ''m'' folder is read-only " ...
        + "(e.g. clone without write permission or different user). " ...
        + "Fix: make the Zeffiro root and ''m'' folder writable, e.g. chmod -R u+w .", ...
        start_config ...
    ) ;
end
