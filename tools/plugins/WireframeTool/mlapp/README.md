...
MATLAB logic: `tools/plugins/WireframeTool/m/` (`zef_wireframe_creator_start`, `zef_wireframe_filling_vec`, `wireframe`, `zef_wireframe_permittivity_vec`, `zef_wireframe_plot`).
