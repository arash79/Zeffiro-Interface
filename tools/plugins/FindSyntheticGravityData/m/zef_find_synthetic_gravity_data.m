%ZEF_FIND_SYNTHETIC_GRAVITY_DATA  Open the synthetic gravity data window.
%
%   Zeffiro Interface.
...
%
%   Not in the default profile INI. Script: opens
%   find_synthetic_gravity_data.fig. Compute writes zef.measurements via
%   zef_synthetic_gravity_data → zef_compute_gravity_data (density rho +
%   ROI spheres). Needs nodes, tetra, rho, sensors, imaging_method 1–4.
%
%   See also zef_synthetic_gravity_data, zef_compute_gravity_data.
%
...
uistack(flipud([zef.h_inv_roi_sphere_1;  zef.h_inv_roi_sphere_2;
    ...
    zef.h_inv_compute_data; zef.h_inv_plot_roi ])
,'top');
