...
%
%   Plot-sources button uses type 1 (zef.inv_synth_source). Type 2
%   reads zef.inv_rec_source. Deletes previous h_synth_source /
%   h_rec_source. Reads base zef; draws on h_axes1 via
%   zef_plot_3D_arrow. Does not write measurements.
%
%   See also zef_plot_source_intensity, zef_update_fss.
