%ZEF_UPDATE_EXP_IAS_MULTIRES  IAS-multires widgets → zef.exp_ias_* / inv_* plus sparsity.
%
%   Zeffiro Interface.
...
%
%   Script. Same as zef_update_exp_ias plus multires level/sparsity edits.
%   Called before exp_ias_iteration_multires.
%
