...
%
% Zef fields (observed):
%   zef.exp_ias_multires_beta (read, write)
%   zef.exp_ias_multires_hyper_type (read, write)
%   zef.exp_ias_multires_q (read, write)
%   zef.exp_ias_multires_theta0 (read, write)
