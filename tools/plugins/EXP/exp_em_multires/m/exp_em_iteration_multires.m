...
% exp_em_iteration_multires — Exp em iteration multires.
%
% Purpose:
%   Exp em iteration multires.
...
%
% Zef fields (observed):
%   zef.exp_em_multires_beta (read)
%   zef.exp_em_multires_hyper_type (read)
%   zef.exp_em_multires_q (read)
%   zef.exp_em_multires_sparsity (read)
%   zef.exp_em_multires_theta0 (read)
%   zef.exp_multires_dec (read)
%   zef.exp_multires_ind (read)
%   zef.exp_multires_n_decompositions (read)
%   zef.exp_multires_n_iter (read)
...
%   Programmatic: `[[z, reconstruction_information]] = exp_em_iteration_multires(void)` with project root and `src` on the path.
