...
h1 = figure(...
    ...
    'MenuBar','none',...
    'ToolBar','none',...
    'Name','ZEFFIRO Interface: Hierarchical Bayesian MCMC sampler',...
    'NumberTitle','off',...
...
h2b = uicontrol(...
    ...
    'String','Sample size:',...
    'Style','text',...
    'Position',[0.0348311365552745 0.831 0.475482378930655 0.0446621923937361],...
    'Children',[],...
    'Tag','text2',...
    'UserData',[],...
    'FontSize',0.44324942791762,...
...
h3b = uicontrol(...
    ...
    'Style','edit',...
    'Value',1,...
    'Position',[0.790635216497286 0.831 0.180967174070622 0.04976644295302],...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.inv_sample_size = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit3',...
    'FontSize',0.397787948131197);

zef.h_mcmc_sample_size = h3b;
...
h17 = uicontrol(...
    ...
    'Style','edit',...
    'Value',1,...
    'Position',[0.790635216497286 0.90 0.180967174070622 0.04976644295302],...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.inv_snr = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit11',...
...
h5 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.inv_n_burn_in = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit3',...
    'FontSize',0.397787948131197);

zef.h_mcmc_n_burn_in = h5;
...
h7 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.mcmc_sampling_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit6',...
    'FontSize',0.397787948131197);

zef.h_mcmc_sampling_frequency = h7;
...
h9 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.mcmc_low_cut_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit7',...
    'FontSize',0.397787948131198);

zef.h_mcmc_low_cut_frequency = h9;
...
h11 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.mcmc_high_cut_frequency = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '',...
    'Tag','edit8',...
    'FontSize',0.397787948131197);

zef.h_mcmc_high_cut_frequency = h11;
...
h12 = uicontrol(...
    ...
    'Callback','zef_update_mcmc; zef.reconstruction = zef_mcmc(zef);',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','pushbutton12',...
    'FontSize',0.280661496737012);

zef.h_mcmc_start = h12;
...
h13 = uicontrol(...
    ...
    'Callback','close(zef.h_mcmc_cm_estimation);',...
    'Children',[],...
    'CreateFcn','',...
    'Tag','pushbutton13',...
    'FontSize',0.280661496737012);

zef.h_mcmc_cancel = h13;
...
h15 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.number_of_frames = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit10',...
    'FontSize',0.397787948131197);

zef.h_mcmc_number_of_frames = h15;
...
h18 = uicontrol(...
    ...
    'Callback','zef_update_mcmc;',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','pushbutton14',...
    'FontSize',0.280661496737012);

zef.h_mcmc_apply = h18;
...
h20 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.normalize_data = get(gcbo,''value'');',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','popupmenu8',...
    'UserData',[],...
...
h24 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.inv_time_2 = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit15',...
    'FontSize',0.397787948131197);

zef.h_mcmc_time_2= h24;
...
h26 = uicontrol(...
    ...
    'BackgroundColor',[1 1 1],...
    'Callback','zef.inv_time_3 = str2num(get(gcbo,''string''));',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','edit19',...
    'FontSize',0.397787948131197);

zef.h_mcmc_time_3= h26;
