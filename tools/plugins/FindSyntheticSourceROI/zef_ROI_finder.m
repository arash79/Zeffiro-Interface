...
%ZEF_ROI_FINDER  Source indices inside a spherical, flat, or ellipsoidal ROI.
%
%   Zeffiro Interface.
...
%
%   roi_specs.shape: 1 flat/curved disk, 2 sphere, 3 spheroid. Empty ROIs
%   snap the centre to the nearest source and retry. If the ROI is not
%   empty, the geometric centre need not coincide with a source point.
%
%   See also zef_find_source_ROI.
