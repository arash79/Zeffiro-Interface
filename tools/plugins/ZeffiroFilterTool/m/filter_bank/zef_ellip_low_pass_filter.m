...
% zef_ellip_low_pass_filter — Zef ellip low pass filter.
%
% Purpose:
%   Zef ellip low pass filter.
...
%
% Calls (project):
%   zef_ellip_low_pass_filter
%
% Workflow:
%   GUI: Used indirectly through tools, menus, or `zef_update` refresh chains.
%   Programmatic: `[processed_data] = zef_ellip_low_pass_filter(f, filter_order, ripple, attenuation, …)` with project root and `src` on the path.
