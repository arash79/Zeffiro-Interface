...
MATLAB logic: `tools/plugins/ZeffiroFilterTool/m/` (`zef_filter_tool`, `zef_filter_raw_data`, stages under `m/filter_bank/`).
...
- Pipeline save/load is `.mat` v7.3, not JSON; Load uses project `zef.file` / `zef.file_path`.
