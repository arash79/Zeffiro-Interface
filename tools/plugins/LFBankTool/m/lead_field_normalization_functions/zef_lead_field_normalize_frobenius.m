...
% zef_lead_field_normalize_frobenius — Builds or applies a sensor lead-field matrix for forward/inverse pipelines.
%
% Purpose:
...
%
% Calls (project):
%   zef_lead_field_normalize_frobenius
%
% Side effects:
...
%   Programmatic: `[[L, measurements]] = zef_lead_field_normalize_frobenius(lf_bank_index)` with project root and `src` on the path.
