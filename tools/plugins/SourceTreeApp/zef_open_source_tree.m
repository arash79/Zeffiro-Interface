...
%ZEF_OPEN_SOURCE_TREE  Construct the Source tree App Designer window.
%
%   Zeffiro Interface.
...
%
%   Called via zef_tool_start from zef_start_source_tree_tool. Instantiates
%   zef_source_tree_app, restores zef.source_tree if present, and wires
%   node/signal callbacks. Does not run Jansen–Rit until Simulate.
%
%   See also zef_start_source_tree_tool, zef_simulate_jr_tree.
