%% jansen_rit_model.m
% Standalone demo of system (4.45) from Cook et al. (2022) /
% arXiv:2103.10554. Not called by the Source tree app; the app integrates
% the same RHS inside zef_simulate_jr_tree. Running this file opens figures.
%
