...
%
    ...
    arguments
        ...
        lead_field_kwargs.source_model (1,1) core.types.ZefSourceModel = core.types.ZefSourceModel.Hdiv
    ...
    project_struct = utilities.structs.copy_fields(lead_field_kwargs, project_struct);
