%%
% ZEF_KALMANDEMO - Kalman filter-based EEG source reconstruction demo
%
% This script demonstrates Kalman filtering for EEG source reconstruction
% without the Zeffiro Interface GUI. It simulates the somatosensory P20/N20
% component with cortical and thalamic sources, then applies Kalman filtering
% for inverse reconstruction.
%
% Run in sections:
%   Section 1: Create synthetic measurements (mesh + lead field + simulation)
%   Section 2: Run Kalman filter reconstruction
%   Section 3: (Optional) Save results
%   Section 4: (Optional) Visualization (under maintenance)
%
% See also: zef_KF, examples.lead_field_example
