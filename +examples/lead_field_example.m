...
%
% examples.lead_field_example ( kwargs, mesh_kwargs, lead_field_kwargs )
%
% Demonstrates programmatic construction of a lead field matrix using Zeffiro
% Interface from the MATLAB command line. This example builds upon the meshing
% example by first generating a finite-element mesh, then attaching sensors,
% and finally computing the lead field matrix for the specified source model.
%
% See the wiki page for parameter descriptions:
%   https://github.com/sampsapursiainen/zeffiro_interface/wiki/Lead-field-generation
%
% Returns:
%   project_struct  Struct containing the project with mesh and lead field
%
