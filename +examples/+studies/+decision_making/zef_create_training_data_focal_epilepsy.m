...
% Generate synthetic trials: random dipole position + orientation.
for data_ind = 1 : training_data_size
    for snr_ind = 1 : length(snr_vec)
        ...
        % Random source position and unit orientation.
        ...
        % Run EEG inverse methods (MNE, sLORETA, MNE-RAMUS, Dipole Scan, etc.)
        % MNE
