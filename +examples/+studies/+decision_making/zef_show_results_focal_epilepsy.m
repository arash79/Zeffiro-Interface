% ZEF_SHOW_RESULTS_FOCAL_EPILEPSY - Display clustering results in tables and plots
%
% Computes distances from reference points to final max point and to resection
% region, then creates a uifigure with a uitable (method comparison) and a
% plot showing distance-to-reference and distance-to-resection with credibility
% bands. Requires z_ref_points, z_final_max_point, z_max_deviations,
% z_mean_deviations, z_inverse_results, z_inverse_info, z_inverse_info from
