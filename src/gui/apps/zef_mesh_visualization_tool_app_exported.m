...
classdef zef_mesh_visualization_tool_app_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        h_pushbutton_dti_streamlines    matlab.ui.control.Button
    end

    % -------------------------------------------------------------------------
    % Component initialization: build visualization tool figure and all controls
    % -------------------------------------------------------------------------
    methods (Access = private)

        % Create the mesh visualization figure and all UI components (volume/surface
        % visualization, frame/movie, clipping planes, colormap/scale, graphs).
        function createComponents(app)

            % Create main figure; keep hidden until layout is complete.
            ...
            app.h_pushbutton20.Position = [181 582 156 20];
            app.h_pushbutton20.Text = 'Visualize surfaces';

            % Create h_pushbutton22 (frame range and movie generation)
            app.h_pushbutton22 = uibutton(app.h_mesh_visualization_tool, 'push');
            app.h_pushbutton22.Position = [12 556 158 20];
            ...
            % Reconstruction type: how inverse solution is displayed (amplitude, normal, etc.).
            ...
            app.h_axes_popup.Position = [181 556 156 20];
            app.h_axes_popup.Text = 'Axes pop-up';

            % --- Parameter and graph listboxes for time-series / graph plotting ---
            ...
            % Create h_pushbutton_dti_streamlines (diffusion tensor imaging streamlines)
            app.h_pushbutton_dti_streamlines = uibutton(app.h_mesh_visualization_tool, 'push');
            app.h_pushbutton_dti_streamlines.Position = [12 530 325 20];
            app.h_pushbutton_dti_streamlines.Text = 'Visualize DTI streamlines';
    ...
    methods (Access = public)
        ...
        function app = zef_mesh_visualization_tool_app_exported
        ...
        % Destructor: remove the visualization tool figure when the app is destroyed.
        function delete(app)
