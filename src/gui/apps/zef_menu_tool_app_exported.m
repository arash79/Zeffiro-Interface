...
properties (Access = public)
    ...
    % -------------------------------------------------------------------------
    % Component initialization: build the menu figure and all menu items
    % -------------------------------------------------------------------------
    methods (Access = private)

        % Create the main UI figure and all menu components (Project, Export,
        % Import, Edit, Inverse/Forward tools, Multi-tools, Settings, Window, Help).
        function createComponents(app)

            % Create main figure; keep hidden until layout is complete to avoid flicker.
    ...
    methods (Access = public)
        ...
        function app = zef_menu_tool_app_exported
            ...
            if isempty(runningApp)
                % No instance running: create UI and register with App Designer.
        ...
        % Destructor: remove the main figure when the app object is destroyed.
        function delete(app)
