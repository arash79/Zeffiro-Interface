...
classdef zef_mesh_tool_app_exported < matlab.apps.AppBase
    ...
    % -------------------------------------------------------------------------
    % Properties: main figure, buttons, tables, edit fields, context menus
    % -------------------------------------------------------------------------
    ...
    % -------------------------------------------------------------------------
    % Component initialization: build mesh tool figure and all controls
    % -------------------------------------------------------------------------
    methods (Access = private)

        % Create the mesh tool figure and all UI components (mesh creation,
        % postprocessing, resampling, interpolation, forward simulation table/script).
        function createComponents(app)
            ...
            % --- Mesh creation and postprocessing buttons ---
            ...
            % Run script executes the forward simulation script in the text area.
            ...
            % Source interpolation: map source/field between meshes.
            ...
            % Attach context menu to forward simulation table (Add/Delete rows).
    ...
    methods (Access = public)
        ...
        function app = zef_mesh_tool_app_exported
        ...
        % Destructor: remove the mesh tool figure when the app is destroyed.
        function delete(app)
