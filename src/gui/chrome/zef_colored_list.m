...
try
    ...
    st.sel = th.color.selection;
    st.chip = th.color.border;
    st.scroll = th.color.border;
catch
end
ud.Suppress = true;
h.UserData = ud;
...
'html,body{margin:0;padding:0;height:100%;background:var(--zbg,#fff);}' ...
'#list,#list .row{font-family:Helvetica,Arial,sans-serif;font-size:11px;' ...
'color:var(--zfg,#111);}' ...
'#list{height:100%;overflow-x:hidden;overflow-y:auto;background:var(--zbg,#fff);user-select:none;padding:4px 2px;box-sizing:border-box;scrollbar-width:thin;}' ...
'#list::-webkit-scrollbar{width:8px;}' ...
'#list::-webkit-scrollbar-thumb{background:var(--zscroll,#c5cdd0);border-radius:4px;}' ...
'#list::-webkit-scrollbar-track{background:transparent;}' ...
'.row{margin:0;padding:2px 8px;border:0;line-height:18px;min-height:18px;' ...
'display:flex;align-items:center;overflow:hidden;cursor:default;}' ...
'.row:hover{background:var(--zhover,#f3f3f3);}' ...
'.row.sel{background:var(--zsel,#d7e8ea);}' ...
'.chip{display:inline-block;width:9px;height:9px;margin-right:6px;flex:0 0 9px;' ...
'border-radius:2px;border:1px solid var(--zchip,rgba(0,0,0,.22));}' ...
