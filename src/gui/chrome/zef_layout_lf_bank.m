...
r4 = local_grid(root, [1 2], theme);
r4.ColumnWidth = {'1x', '1x'};
r4.ColumnSpacing = 8;
r4.Padding = [0 0 0 0];
...
local_put(r4, norm, 1, 2);

r5 = local_grid(root, [1 3], theme);
r5.ColumnWidth = {'1x', 'fit', 'fit'};
r5.ColumnSpacing = 8;
r5.Padding = [0 0 0 0];
...
local_put(r5, cmp, 1, 2);
local_put(r5, mk, 1, 3);

zef_ui_hide_orphans(fig);
zef_ui_apply_size(fig, 920, 440, 760, 360);
try
    fig.AutoResizeChildren = 'off';
catch
end
