...
% zef_update_transparency_surface — Syncs GUI control values into `zef` for transparency_surface.
%
% Purpose:
%   Syncs GUI control values into `zef` for transparency_surface.
...
%   Programmatic: `[slider_value_new] = zef_update_transparency_surface(varargin)` with project root and `src` on the path.
