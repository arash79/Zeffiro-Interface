...
set(zef.h_forward_simulation_update_from_profile,'ButtonPushedFcn','zef.forward_simulation_table = zef_read_profile_cell([zef.program_path ''/profile/'' zef.profile_name ''/zeffiro_forward_simulation.ini'']);zef.h_forward_simulation_table.Data = zef.forward_simulation_table;');
...
if isempty(zef.forward_simulation_table)
    zef.forward_simulation_table = zef_read_profile_cell([zef.program_path  filesep 'profile' filesep zef.profile_name filesep 'zeffiro_forward_simulation.ini']);
end
