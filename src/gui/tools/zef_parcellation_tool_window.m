...
h53 = uicontrol(...
    ...
    'Style','edit',...
    'Position',[0.515 0.805 0.435 0.0351351351351351],...
    'BackgroundColor',[0.9 0.9 0.9],...
...
h18 = uicontrol(...
    ...
    'Callback','[zef.yesno] = zef_ui_confirm(''Reset colortable and points?''); if isequal(zef.yesno,''Yes''); zef_parcellation_reset; end',...
    'Children',[],...
    'CreateFcn', '' ,...
    'Tag','pushbutton8',...
    'FontSize',0.293497210599722);
