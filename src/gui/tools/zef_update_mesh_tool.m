...
%
%   Script. Copies Mesh smoothing / Refinement / LF source interp. /
%   Resample surf. and numeric fields; writes the selected
%   forward-simulation table cell from the script box.
