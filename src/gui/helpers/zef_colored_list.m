...
'.row{margin:0;padding:1px 4px;border:0;line-height:16px;height:16px;' ...
'white-space:nowrap;cursor:default;}' ...
'.row:hover{background:#f3f3f3;}' ...
'.row.sel{background:#cfe8ff;}' ...
