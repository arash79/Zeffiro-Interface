...
try
    tbl.RowStriping = 'on';
    tbl.BackgroundColor = [1.000 1.000 1.000; 0.948 0.956 0.960];
catch
end
...
if any(contains(nm, {'script'}))
    w = 2.6;
elseif any(contains(nm, {'name', 'tag'}))
    w = 2.2;
elseif any(contains(nm, {'value', 'plugin', 'description'}))
    w = 1.8;
end
