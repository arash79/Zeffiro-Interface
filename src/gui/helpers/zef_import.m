...
%ZEF_IMPORT  Import a volume mesh .mat (Import → Import volume data).
%
%   Zeffiro Interface.
%   Copyright © 2018- Sampsa Pursiainen & ZI Development Team
%   See: https://github.com/sampsapursiainen/zeffiro_interface
...
%
%   Function. uigetfile('*.mat'); load expects nodes/tetrahedra/sigma in
%   the file. Builds outer surface_triangles from unmatched tetra faces
%   (four local face permutations, sort-rows duplicate test).
%
%   [nodes, tetrahedra, sigma, brain_ind, surface_triangles] = zef_import(_)
