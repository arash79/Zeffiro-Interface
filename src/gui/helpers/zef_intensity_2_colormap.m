function [colormap_vec] = zef_intensity_2_colormap(colortune_param, colormap_size)
%ZEF_INTENSITY_2_COLORMAP  colormap_cell{3} "Intensity II" (green-led ramps).
%
%   Zeffiro Interface.
...
%
%   Same construction as Intensity I with the long ramp on channel 2.
%   zef_init colormap_cell{3}; Figure-tool Colormap: item 3.
%   colormap_vec = zef_intensity_2_colormap(colortune_param, colormap_size)
