...
%   zef_fix_negatives (rows with condition_number < 0); zef_plot_condition
%   (log-histogram on Figure-tool axes). The Mesh-tool plot-condition
%   button that would call zef_plot_condition is commented out.
%
