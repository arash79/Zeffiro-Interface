...
% print(1,'-dpng','-r1200','rdm_high_eccentricity.png')


figure(2);  set(gcf,'renderer','painters');
h_mag = boxchart(x_scale*[index_vec_1; index_vec_2; index_vec_3; index_vec_4],log10(abs([mag_v_1; mag_v_2; mag_v_3; mag_v_4])),'GroupByColor',group_vec, 'MarkerSize', 12);
%set(gca,'yscale','log')
...
% print(2,'-dpng','-r1200','mag_high_eccentricity.png')
