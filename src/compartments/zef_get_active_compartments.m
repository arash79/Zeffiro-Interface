...
%   It is a "brain"/source compartment if <tag>_sources is 1 or 2
%   (Constrained / Unconstrained field). Excluded: 0 Inactive, 3 Active
%   surface, -1 Bounding box / PML. Optional property_name (e.g. 'name')
%   returns that field for each active / source compartment.
%
