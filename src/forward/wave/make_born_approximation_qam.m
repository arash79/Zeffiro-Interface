%MAKE_BORN_APPROXIMATION_QAM  Born Jacobian driver with QAM demodulation.
%
%   Zeffiro Interface (GPU-ToRRe-3D wave module).
%   Copyright © 2021- Sampsa Pursiainen & GPU-ToRRe-3D Development Team
%   See: https://github.com/sampsapursiainen/GPU-Torre-3D
%
%   Script. Same torre_dir layout as the AMP sibling; combines I/Q via qam_demod.
%
%   See also qam_demod, make_born_approximation_amp.
...
%% Born/QAM path: baseline simulation, perturbations, qam_demod Jacobian assembly
