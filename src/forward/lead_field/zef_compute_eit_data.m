...
%
%   Called from zef_synthetic_eit_data (Find synthetic EIT data →
%   Compute). Also callable from MATLAB after setting current_pattern,
%   inv_roi_sphere, inv_roi_perturbation, inv_bg_data, inv_eit_noise.
%
...
%
%   See also zef_synthetic_eit_data, zef_lead_field_eeg_fem.
