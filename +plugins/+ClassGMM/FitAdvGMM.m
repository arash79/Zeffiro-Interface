...
%   with K components to the data in POSITIONS, where each observation has
%   an associated weight in WEIGHT. This is used for brain source reconstruction
%   where weights typically represent current density magnitudes.
%
%   GM = FITADVGMM(POSITIONS, WEIGHT, K) fits a Gaussian mixture distribution with K
...
%
%   See also ADVGMMODELING4REC, GMDISTRIBUTION.

%   Copyright 2007-2017 The MathWorks, Inc.
%   Adapted for Zeffiro Interface weighted GMM.
