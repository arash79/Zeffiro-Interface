...
| `kf_update.m` | `"Basic Kalman filter"`, sKF when smoother type is RTS, and `UKFNMMInverter` spatial stage | Standard update: `K = P H' / (H P H' + R)`, Joseph-style `P` |
