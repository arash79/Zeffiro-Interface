%ZEF_KF_OPEN_WINDOW Open the Kalman filter (KF) configuration window.
%
%   ZEF = ZEF_KF_OPEN_WINDOW(ZEF) launches the KF app UI and populates it
%   with parameters from the Zeffiro project structure ZEF. Used by the
%   Zeffiro Interface to configure Kalman filter reconstruction settings.
%
%   Input:
%     ZEF - Zeffiro project structure (optional; uses base workspace if omitted)
%
%   Output:
%     ZEF - Updated structure with zef.KF app handle
%
