%ZEF_KF_START Launch the Kalman filter (KF) configuration app.
%
%   ZEF_KF_START is the startup script for the KF plugin. Add this as the
%   launch script in zeffiro_plugins.ini under the Kalman/Beamformer
%   section to make the KF tool available from the Zeffiro Interface.
%
%   Requires: zef_kf_app (MLAPP), zef_KF (main computation)
%
